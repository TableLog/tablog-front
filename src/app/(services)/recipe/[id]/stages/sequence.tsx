...
const Sequence = ({ recipe }: SequenceProps) => {
  return (
    <div className="flex gap-3">
      <div className="relative h-[90px] w-[90px] shrink-0 overflow-hidden rounded-md border border-grey07">
        <div className="absolute left-1 top-1 z-10 flex h-5 w-5 items-center justify-center rounded-sm bg-black01/80 text-sm font-semibold text-white01 backdrop-blur-3xl">
          {recipe.sequence + 1}
        </div>
        <Image
