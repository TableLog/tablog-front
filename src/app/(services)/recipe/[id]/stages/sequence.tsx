  ...
  return (
    <div className="flex gap-3">
      <div className="relative h-[90px] w-[90px] shrink-0">
        <div className="bg-black01/50 text-white01 absolute top-1 left-1 z-10 flex h-5 w-5 items-center justify-center rounded-sm text-sm font-semibold backdrop-blur-3xl">
          {recipe.sequence + 1}
        </div>
        <Image
